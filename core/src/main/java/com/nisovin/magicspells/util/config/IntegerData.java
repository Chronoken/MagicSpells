...
public class IntegerData extends ConfigData<Integer> {

	private Expression expression;
	private Integer value;

	public IntegerData(MagicConfig config, String path, Integer def) {
	...
	@Override
	public Integer get(LivingEntity caster) {
